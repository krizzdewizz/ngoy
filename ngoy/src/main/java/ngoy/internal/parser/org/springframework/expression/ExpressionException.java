...
public class ExpressionException extends RuntimeException {
	 ...
	 * 
	 * @param expressionString the expression string
	 * @param position         the position in the expression string where the
	 *                         problem occurred
	 * @param message          a descriptive message
	 */
	 ...
	 * Construct a new expression exception.
	 * 
	 * @param position the position in the expression string where the problem
	 *                 occurred
	 * @param message  a descriptive message
	 */
	...
	/**
	 * Return the exception message. As of Spring 4.0, this method returns the same
	...
	/**
	 * Return the exception simple message without including the expression that
	 * caused the failure.
	 * 
	 * @since 4.0
	 */
