...
public interface OnCompile {
	/**
	 * @param el             The element of the component/directive. Change this
	 *                       element and it's subtree to alter/extend the template
	 * @param componentClass Component class
	 */
	void ngOnCompile(Jerry el, String componentClass);
}
