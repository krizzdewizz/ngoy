...
public class X {
	private static ngoy.core.PipeTransform __$uppercase;

	private static Object $uppercase(Object obj, Object... args) {
		return __$uppercase.transform(obj, args);
	}

	private static ngoy.core.PipeTransform __$date;

	private static Object $date(Object obj, Object... args) {
		return __$date.transform(obj, args);
	}

	private static ngoy.core.PipeTransform __$lowercase;

	private static Object $lowercase(Object obj, Object... args) {
		return __$lowercase.transform(obj, args);
	}

	private static ngoy.core.PipeTransform __$capitalize;

	private static Object $capitalize(Object obj, Object... args) {
	...
	public static void render(ngoy.core.internal.Ctx ctx) throws Exception {
		...
		ngoy.parser.JavaParserTest.Cmp _$l_cmp_1 = (ngoy.parser.JavaParserTest.Cmp) ctx.pushCmpContextInput(ngoy.parser.JavaParserTest.Cmp.class);
		{
			ctx.pushCmpContext(_$l_cmp_1);
			ctx.print("<pre");
			java.util.List<String> _$l_classlist_2 = new java.util.ArrayList<>();
			...
			java.util.List<String> _$l_stylelist_3 = new java.util.ArrayList<>();
			...
			if (_$l_expr_5 != null) {
				_$l_stylelist_3.add("width:".concat(_$l_expr_5.toString())
						.concat("px"));
			}
			...
			for (ngoy.core.internal.IterableWithVariables.Iter _$l_iter_6 = ctx.forOfStart(_$l_cmp_1.getHobbies())
					.iterator(); _$l_iter_6.hasNext();) {
			...
			if (_$l_cmp_1.appName.equals("a")) {
				ngoy.parser.JavaParserTest.PersonCmp _$l_cmp_7 = (ngoy.parser.JavaParserTest.PersonCmp) ctx.pushCmpContextInput(ngoy.parser.JavaParserTest.PersonCmp.class);
				{
					_$l_cmp_7.person = (ngoy.model.Person) _$l_cmp_1.peter;
					_$l_cmp_7.setPerson2(_$l_cmp_1.peter);
					ctx.pushCmpContext(_$l_cmp_7);
					ctx.print("<person ,>");
					ctx.printEscaped("hello: ");
					ctx.printEscaped($date(_$l_cmp_7.person.getName(), "YYYY"));
					ctx.popCmpContext(_$l_cmp_7);
				}
				ctx.print("</person>");
			}
			ctx.popCmpContext(_$l_cmp_1);
		}
	}
}
